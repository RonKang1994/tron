...
public class Game implements Runnable {
	...
	public void run() {
      ...
      // Top-level frame
      final JFrame frame = new JFrame("Tron Light Cycle");
      ...
      final JComponent pict = new JComponent() {
    	  public void paintComponent(Graphics gc) {
    		  ...
    		  Picture.draw(gc, "image/tron_cycle2.jpg", 0, 50);
    	  }
      };
	  ...
	  final JButton instructions = new JButton(
			  new ImageIcon("image/instructions_before.png"));
	 ...
	 @SuppressWarnings("serial")
	  final JComponent instrPict = new JComponent() {
		  public void paintComponent(Graphics gc) {
			  super.paintComponent(gc);
			  Picture.draw(gc, "image/instructions_page.png", 0, 0);
		  }
	  };
	  ...
	  final JButton story = new JButton(new ImageIcon("image/story.png"));
	  modes.add(story);
	  final JButton survival = new JButton(new ImageIcon("image/survival.png"));
	  modes.add(survival);
	 ...
	 @SuppressWarnings("serial")
	  final JComponent menuPict = new JComponent() {
		 public void paintComponent(Graphics gc) {
			 super.paintComponent(gc);
			 Picture.draw(gc, "image/play_menu2.jpg", 0, 0);
		 }
	  };
	  ...
	  final JButton highScores = new JButton(new ImageIcon("image/high_scores.png"));
	  ...
	  final JButton reset = new JButton(new ImageIcon("image/restart.png"));
	  survMenu.add(reset);
	  final JButton exit = new JButton(new ImageIcon("image/play_before.png"));
	  survMenu.add(exit);
	  ...
	  final JButton resetStory = new JButton(new ImageIcon("image/restart.png"));
	  storyMenu.add(resetStory);
	  final JButton exitStory = new JButton(new ImageIcon("image/play_before.png"));
	  storyMenu.add(exitStory);
	  
	  // the story level
      final TronMapSinglePlayer levelStory =
    		  new TronMapSinglePlayer(scoreStory1, scoreStory2, 2);
	  ...
	  instructions.addActionListener(new ActionListener() {
		  public void actionPerformed(ActionEvent e) {
			  if (instructOn) {
				  ...
				  instructions.setIcon(new ImageIcon("image/main_menu.png"));
			  }
			  mainMenu.revalidate();
			  frame.repaint();
